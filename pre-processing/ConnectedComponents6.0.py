...
local_path = '/Users/ale57/Documents/1. universita\'/tesi/Nebbia/'
nebbia_path = 'home/nebbia/alovo/'
home_path = local_path
output_path = home_path +str(data)+'/'+str(video)+'/trigger_thr'+str(discriminant_thr)+'/'
